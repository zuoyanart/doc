...
mkdir data/soft;
cd data/soft;
wget http://golangtc.com/static/go/1.6.2/go1.6.2.linux-386.tar.gz && mkdir golang && tar -zxvf go1.6.2.linux-386.tar.gz -C /data/soft/golang;
...
echo "export GOARCH=386" >> /etc/profile;
